...
const NavBar1 = () => {
  ...
  return (
    ...
    <header className="fixed shadow-md w-full h-16 px-2 md:px-4 z-10 bg-white">
      {/* desktop */}
      <div className="flex items-center h-full justify-between">
        ...
        <div className="flex items-center gap-4 md:gap-5">
          ...
          <div className="hover:scale-125 transition-all duration-300 text-2xl mt-1 text-slate-600 cursor-pointer relative">
           <Link to={"cart"}>
           <BsCartFill />
            </Link>  
          ...
          <div className="text-xl cursor-pointer text-slate-600" onClick={handleClick}>
            <div className='hover:scale-125 transition-all duration-300 flex items-center justify-center w-10 h-10 drop-shadow-xl overflow-hidden cursor-pointer rounded-full '>
